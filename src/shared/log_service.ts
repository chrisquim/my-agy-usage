...
class Logger {
    ...
    init(): void {
        ...
        this.outputChannel = vscode.window.createOutputChannel('My Antigravity Usage');
        this.isInitialized = true;

        this.configDisposable = vscode.workspace.onDidChangeConfiguration((e) => {
            if (e.affectsConfiguration('myAgyUsage.logLevel')) {
                this.updateLogLevel();
            }
        });
    ...
    private updateLogLevel(): void {
        const config = vscode.workspace.getConfiguration('myAgyUsage');
